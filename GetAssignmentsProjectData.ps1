#GetAssignmentsProjectData

Param([string]$project_id)

$url ='https://api.10000ft.com/api/v1/projects/' + $project_id + '/assignments'
...
$r=Invoke-WebRequest -Uri $url -Method GET -Headers $headers -OutFile 'C:\Temp\10kFT\AssignmentsProjectData.json'

#válasz fájl beolvasás
$json_response = Get-Content C:\Temp\10kFT\AssignmentsProjectData.json
