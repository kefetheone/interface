...
$url = 'https://api.10000ft.com/api/v1/holidays'
...
$r=Invoke-WebRequest -Uri $url -Method GET -Headers $headers -OutFile 'C:\Temp\10kFT\HolidaysData.json'

#válasz fájl beolvasás
$json_response = Get-Content C:\Temp\10kFT\HolidaysData.json
