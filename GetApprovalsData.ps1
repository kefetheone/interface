...
$url = 'https://api.10000ft.com/api/v1/approvals'
...
$r=Invoke-WebRequest -Uri $url -Method GET -Headers $headers -OutFile 'C:\Temp\10kFT\ApprovalsData.json'

#válasz fájl beolvasás
$json_response = Get-Content C:\Temp\10kFT\ApprovalsData.json
